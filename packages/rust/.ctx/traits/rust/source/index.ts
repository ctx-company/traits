...
const reviewerAgent = rustReviewerRole("reviewer", "Drafts and/or reviews Rust work in a bounded refinement loop.");

const engineeringStandards = resource({
  id: "engineering-standards",
  path: "resources/engineering-standards.md",
  hint: "Rust engineering doctrine: fmt/clippy baseline, module and API shape, error handling, testing, and dependency conventions; agents read this file with their own tools and never inline it.",
...
const gateConventions = resource({
  ...
  hint: "The three Rust validation gates (fmt --check, check, clippy -D warnings), how to read a failure, and how to report gate results; agents read this file with their own tools.",
  trigger: "on-activation",
});
