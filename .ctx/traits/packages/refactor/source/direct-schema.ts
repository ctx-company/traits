...
export const directLinePoint = schema.object("line-point", {
...
export const directAnnotation = schema.object("annotation", {
    file: schema.field(schema.text(), { description: "Repo-relative path of the annotated file." }),
    lines: schema.field(schema.union([schema.list(schema.integer()), schema.list(directLinePoint)]), {
...
export const directAnnotations = schema.object("annotations-doc", {
    annotations: schema.list(directAnnotation),
