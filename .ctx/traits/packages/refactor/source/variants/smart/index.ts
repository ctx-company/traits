...
const researchText = input.prompt`
...
export default function () {
    ...
    smart1.prompt("Research prior art (smart-1)", { id: "research", input: researchText, output: researchNotes });
    ...
    worker.prompt("Implement the refactor (worker)", { id: "implement", input: implementText, output: workSummary });

    flow.loop("Doubly-reviewed refinement with amendments", (loop) => {
        ...
        worker.prompt("Apply reviewer fixes and amendments (worker)", {
            id: "apply-fixes",
