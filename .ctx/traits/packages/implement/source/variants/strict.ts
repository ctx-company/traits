import { deviationReportSchema, LEFTOVER_DOCTRINE, reviewerVerdict, reviewVerdictSchema, REVIEW_VERDICT_DOCTRINE, SCOPE_SPLIT_DOCTRINE, STRICT_VARIANT_DOCTRINE } from "@ctx-traits/agents";
...
const verdict1 = slot({ id: "review-verdict-1", schema: reviewVerdictSchema, description: "smart-1's refinement verdict for the current work state." });
const verdict2 = slot({ id: "review-verdict-2", schema: reviewVerdictSchema, description: "smart-2's refinement verdict for the current work state." });
