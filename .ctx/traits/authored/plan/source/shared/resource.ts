...
- Cover the work with the FEWEST coherent tasks; a plan disproportionate to what was asked is wrong even when every task is well-formed. Sizing to swift agent runs is architect's decomposition judgment, not plan's.
