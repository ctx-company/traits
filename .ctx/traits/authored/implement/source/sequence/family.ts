...
import { effect, flow, input, port, resource, schema, signal, slot } from "@ctx-traits/cdk";

// Redistributed into source/shared/data.ts (0183 step 1: quick); re-exported
// here so the still-legacy variants keep compiling unchanged until they
// migrate too.
export { gateTimedOut, gateTimedOutAbortIf, repoGatesPassed, reviewDiff } from "../shared/data.ts";
