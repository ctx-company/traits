...
import { smart, worker } from "../agent.ts";
import { draft, task, verdict, workSummary } from "../data.ts";
...
export const apply = cdk.stage({
  ...
  output: workSummary,
  include: [verdict.optional(), workSummary.optional(), repoGatesPassed.optional()],
});
