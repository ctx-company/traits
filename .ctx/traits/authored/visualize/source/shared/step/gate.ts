...
// markdown walkthrough to ctx-annotate. Empty annotations accept; a
// decision with annotations is emitted verbatim as binding corrections
// or deepening requests. 'off' auto-approves for unattended runs.
