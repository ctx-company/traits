    ...
    match command {
        cli::Command::Traits {
            ...
            Some(cli::TraitsCommand::Create {
                ...
                // No id at all is the listing form, whether or not a
                // template was named: there is nothing to scaffold into.
                None => crate::app::new::handle_list_templates(json),
                Some(id) => crate::app::new::handle_new(
                    id,
                    name.as_deref().unwrap_or(id),
                    from.as_deref().unwrap_or("plain"),
                    json,
                ),
            },
