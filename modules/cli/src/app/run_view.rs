...
use projection::{
    active_step_index, apply_ledger_seed, completed_narration, display_narration, run_view,
};
#[cfg(test)]
use projection::{
    canonical_status_path, command_succeeded, history_outcome, history_step_from_status,
    latest_frame_event_rows, ledger_presentation_seed, planned_item_for_status,
    sidecar_step_summary_maps,
};
...
use planned::{active_loop_container_keys, status_tone};
#[cfg(test)]
use planned::{stamp_control_stack_iterations, structural_step_key};
use session_text::{active_key, active_label};
