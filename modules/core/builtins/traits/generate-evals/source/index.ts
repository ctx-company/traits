...
const scenario = schema.object("scenario", {
  id: schema.text(),
  variant: schema.text(),
  input: schema.text(),
  output: schema.text(),
});
const evalProposal = schema.object("eval-proposal", {
  id: schema.text(),
  variant: schema.text(),
  input: schema.text(),
  output: schema.text(),
...
const synthesisPort = port.output.of({
  id: "eval-synthesis",
  schema: ref.schema("eval-synthesis-scaffold"),
