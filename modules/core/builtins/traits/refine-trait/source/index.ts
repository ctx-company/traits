...
const sourcePath = port.input.text({ id: "source-path", description: "Filesystem path whose lines anchors must reference; also the round evaluator's re-read source." });
